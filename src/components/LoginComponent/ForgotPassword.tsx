...
import { sendOtpForPasswordReset } from '../../actions/authActions';
...
const ForgotPassword = () => {
    ...
    const { otpToken, resetToken, error, loading } = useSelector((state: any) => state.auth);
        ...
        <div className="min-h-screen bg-[#0d1117] flex justify-center font-roboto">
            <div className="flex flex-col">
                <div className="flex justify-center pb-7 pt-10">
                    <img className="h-48" src="src/assets/buildings.svg" alt="Buildings" />
                </div>
